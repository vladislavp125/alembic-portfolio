...
def upgrade() -> None:
    ...
    sa.Column('can_use_claude', sa.Boolean(), nullable=True),
    ...
    sa.Column('claude_messages_count', sa.Integer(), nullable=True),
    ...
    sa.Column('claude_messages_count', sa.Integer(), nullable=True),
    sa.Column('claude_tokens_input', sa.Integer(), nullable=True),
    sa.Column('claude_tokens_output', sa.Integer(), nullable=True),
    sa.Column('claude_sessions_count', sa.Integer(), nullable=True),
